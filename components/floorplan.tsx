        ...
        <section className="grid grid-cols-1 xl:grid-cols-12 lg:items-end gap-14 md:gap-24">
            <div className="flex flex-col lg:col-span-6 gap-10">
                ...
                <div className="flex gap-2">
                    ...
                    <div>
                        <p className="font-sans"><span className="font-bold">Rummeligt kontor med mødelokale. </span>Kontoret er ca. 50 kvm, udrustet med hurtigt internet (1000/1000) og har mødelokale med fladskærm og whiteboard.</p>
                    </div>
                </div>
                <div className="flex gap-2">
                    <div className="mt-1.5">
                        <Image src={"/icons/clock-solid.svg"} width={35} height={35} alt="SOLA"/>
                    </div>
                    <div>
                        <p className="font-sans"><span className="font-bold">God beliggenhed og åbent 24/7. </span>Vi ligger blot et stenkast fra motorvejsafkørsel, s-tog, bus og hyggelige grønne områder.</p>
                    </div>
                </div>
            </div>
