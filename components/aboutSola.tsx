        ...
        <section id="community" className="grid grid-col-1 lg:grid-cols-12 gap-8 items-end">
            <div className="col-span-6">
                <div className="flex flex-col gap-8">
                    ...
                    <p className="font-sans max-w-lg font-medium">SOLA er stiftet af vennerne Emil og Jannik, der til daglig selv sidder i kontorfællesskabet. 
                        ...
                        Idéen med SOLA-konceptet stammer fra det amerikanske “coffice”, hvor kaffen er et så vigtigt omdrejningspunkt, at man har professionelle baristaer knyttet til kontoret.</p>
