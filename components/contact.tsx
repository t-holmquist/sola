...
export const Contact = () => {
  return (
    <div className="flex relative flex-col items-center gap-8 text-center">
        ...
        <p className="text-black font-sans sm:max-w-lg max-w-80">Eller send os en mail og hør mere om vores faciliteter, området eller vores fremtidige planer for kontorfællesskabet</p>
